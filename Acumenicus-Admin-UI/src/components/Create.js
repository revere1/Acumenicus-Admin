                    ...
                    <div className="container">
                        <div className="panel panel-default">
                            ...
                            <div className="panel-body">
                                <h4><Link to="/" className="btn btn-primary">ROLE List</Link></h4>
                                <form onSubmit={e => {
                                    e.preventDefault();
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="isbn">Role Name:</label>
                                        <input type="text" className="form-control" name="isbn" ref={node => {
                                            isbn = node;
                                        }} placeholder="ISBN" />
                                    </div>
                                    <div className="form-group">
                                        <label htmlFor="title">Suggestion Video Link:</label>
                                        <input type="text" className="form-control" name="title" ref={node => {
                                            title = node;
                                        }} placeholder="Title" />
                                    </div>
                                    <div className="form-group">
                                        <label htmlFor="author">Job Openings:</label>
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="author">Average Salaries:</label>
                                        <input type="text" className="form-control" name="publisher" ref={node => {
                                            publisher = node;
                                        }} placeholder="Publisher" />
                                    </div>
                                    <div className="form-group">
                                        <label htmlFor="author">Salary growth:</label>
